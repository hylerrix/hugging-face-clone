    ...
    <main className="flex flex-1 flex-col">
      <div className="flex-1">
        <div className="container pb-32 pt-28 text-center 2xl:pb-40 2xl:pt-32">
          ...
          <h1 className="mx-auto max-w-xl text-4xl font-bold text-gray-900 dark:text-gray-100 md:text-6xl">The AI
            community building the future.
          </h1>
          <p className="mx-auto mt-6 max-w-md text-lg text-gray-500">Build, train and deploy state of the art
            models powered by the reference open source in machine learning.</p>
          <div className="flex items-center justify-center mt-12">
            <a href="https://github.com/huggingface/transformers" className="btn -mr-1 text-lg font-bold">
              <svg className="dark:text-gray-200 mr-2" xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img"
                width="1.03em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 250">
                <path
            ...
            <div className="relative ml-3">
              <div
                className="from-gray-100-to-white absolute -left-1 top-3.5 z-[-1] h-3 w-3 flex-none rotate-45 transform rounded-sm border border-gray-200 bg-gradient-to-t dark:border-gray-850 dark:bg-gray-900">
              </div>
              <a className="btn inset-0 text-lg font-bold dark:hover:text-yellow-500"
                href="https://github.com/huggingface/transformers">106,934</a>
            </div>
          </div>
        </div>
        <div className="mx-auto max-w-5xl px-4 pb-16 text-center 2xl:max-w-6xl">
          ...
          <div className="font-sm mb-6 inline-block bg-white px-4 text-gray-500">More than 5,000 organizations are
            using Hugging Face</div>
          <div className="grid gap-3 text-left md:grid-cols-2 lg:grid-cols-4">
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/allenai">
                <img alt="Allen Institute for AI's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/facebook">
                <img alt="Meta AI's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/amazon">
                <img alt="Amazon Web Services's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/google">
                <img alt="Google's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/Intel">
                <img alt="Intel's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/speechbrain">
                <img alt="SpeechBrain's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/microsoft">
                <img alt="Microsoft's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
            ...
            <article className="overview-card-wrapper   ">
              <a className="flex flex-1 items-center overflow-hidden p-2" href="/grammarly">
                <img alt="Grammarly's profile picture" className="mr-3 flex-none rounded-lg h-8 w-8"
        ...
        <div className="container grid gap-x-6 gap-y-12 lg:grid-cols-3 lg:gap-y-0">
          <div className="lg:-mt-6 lg:self-center lg:pr-12">
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  <svg className="text-orange-400 text-xl" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img"
                  ...
                  <h2 className="false text-2xl font-semibold leading-tight text-gray-800">Home of Machine
                    Learning</h2>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="max-w-sm leading-snug text-gray-500">
                Create, discover and collaborate on ML better.<br />Join the community to start your ML
                journey.

              </p>
              <div className="h-6"></div>
              <a href="/join"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Sign
                Up</a>
            </div>
          </div>
          <div className="relative lg:col-span-2">
            <img
              ...
              style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} src="/front/assets/activity-feed.png"
            ...
            <img
              ...
              style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} src="/front/assets/activity-feed-mobile.png"
              alt="Hugging Face Hub dashboard" />
          </div>
        </div>
      </div>
      <div
        className="max-w-full overflow-hidden border-b border-t border-gray-100 bg-gradient-to-br py-24 dark:from-gray-950 dark:to-gray-900 md:py-32">
        <div className="container grid grid-cols-1 gap-y-12 md:grid-cols-4 md:gap-y-0">
          <div className="pr-12 md:col-span-1">
            <div className="flex flex-col">
              <svg className="text-green-400 text-xl" xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em"
                preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                <path className="uim-tertiary"
                  d="M15.273 18.728A6.728 6.728 0 1 1 22 11.999V12a6.735 6.735 0 0 1-6.727 6.728z" opacity=".5"
                  fill="currentColor"></path>
                <path className="uim-primary" d="M8.727 18.728A6.728 6.728 0 1 1 15.455 12a6.735 6.735 0 0 1-6.728 6.728z"
                  fill="currentColor"></path>
              </svg>
              <div className="h-2"></div>
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h2 className="false text-2xl font-semibold leading-tight text-gray-800">Problems
                    solvers</h2>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">Thousands of creators work as a community to solve
                Audio, Vision, and Language with AI.
              </p>
              <div className="h-6"></div>
              <a href="/tasks"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Explore
                tasks</a>
            </div>
          </div>
          <div
            className="relative ml-auto flex space-x-3 bg-gradient-to-b from-white via-purple-100/40 to-white md:col-span-3">
            <div className="-ml-16 flex space-x-2 md:-ml-0">
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/audio-classification">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-green-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img"
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Audio
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/image-classification">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-blue-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" fill="currentColor" focusable="false"
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Image
                    Classification</header>
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/object-detection">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-yellow-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" fill="currentColor" focusable="false"
                    role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32">
                    <path
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Object Detection
                  </header>
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/question-answering">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-blue-400" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Question Answering
                  </header>
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/summarization">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-indigo-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" fill="currentColor" focusable="false"
                    role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 18 19">
                    <path
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Summarization
                  </header>
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/text-classification">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-orange-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" fill="currentColor" focusable="false"
                    role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Text Classification
                  </header>
              ...
              <div className="first:hidden 2xl:first:block">
                <a className="transition:all dark:hover:brightness-120 relative flex h-52 w-[9.24rem] flex-none flex-col items-center justify-center rounded-xl border border-gray-100 bg-gradient-to-br from-white to-white p-3 shadow-none duration-100 hover:translate-y-1 hover:shadow-inner hover:brightness-[102%] dark:from-gray-800 dark:to-gray-900 dark:!shadow-none"
                  style={{ boxShadow: '0 0px 16px 0 rgb(68 195 255 / 8%)' }} href="/tasks/translation">
                  <svg className="text-3xl mb-6 mx-auto flex-none text-green-400" xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" fill="currentColor" focusable="false"
                    role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 18 18">
                    <path
                  ...
                  <header className="mb-2 text-center text-lg font-semibold leading-5">Translation
                  </header>
      ...
      <div
        className="border-b border-gray-100 bg-gradient-to-bl from-purple-50 via-white to-blue-100/40 py-16 dark:from-gray-950 dark:to-gray-900 md:py-32">
        <div className="container grid gap-6 lg:grid-cols-3">
          <div className="lg:place-self-center lg:pr-12">
            <div className="flex flex-col">
              <svg className="text-blue-400 text-lg" xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h2 className="false text-2xl font-semibold leading-tight text-gray-800">Transformers
                  </h2>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">
                Transformers is our natural language processing library and our hub is now open to all
                ML models, with
                support from libraries like
                <a target="_blank" className="underline" href="https://github.com/flairNLP/flair">Flair</a>
                ,
                <a target="_blank" className="underline" href="https://github.com/asteroid-team/asteroid">Asteroid</a>
                ,
                <a target="_blank" className="underline" href="https://github.com/espnet/espnet">ESPnet</a>
                ,
                <a target="_blank" className="underline" href="https://github.com/pyannote/pyannote-audio">Pyannote</a>
                , and
                more to come.
              ...
              <a href="https://huggingface.co/transformers"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Read
                documentation</a>
            </div>
          </div>
          <div className="order-first gap-4 overflow-hidden rounded-lg object-cover md:order-none lg:col-span-2">
            <div
              className="flex items-center justify-center from-blue-100/20 to-blue-100/30 p-0 dark:from-gray-925 dark:to-gray-950 md:rounded-xl md:bg-gradient-to-b md:p-12">
              <div
                className="relative w-full overflow-hidden rounded-xl bg-gradient-to-br border border-gray-100 from-white to-white shadow-sm dark:from-gray-900 dark:to-gray-800 ">
                <div className="absolute top-4 left-4 flex space-x-1.5">
                  <div className="h-2.5 w-2.5 cursor-pointer rounded-full bg-red-500 shadow-xl hover:bg-red-600">
                  </div>
                  <div
                    className="h-2.5 w-2.5 cursor-pointer rounded-full shadow-xl bg-orange-300 hover:bg-orange-400 dark:bg-orange-500 dark:hover:bg-orange-600">
                  </div>
                  <div className="h-2.5 w-2.5 cursor-pointer rounded-full bg-green-500 shadow-xl hover:bg-green-600">
                  </div>
                </div>
                <div
                  className="pointer-events-none w-full truncate px-20 pt-3 text-center text-xs text-gray-300 dark:text-gray-600">
                  huggingface@transformers:~</div>
                <div className="px-4 pb-5 pt-3.5" translate="no">
                  <pre className="overflow-x-auto text-xs md:text-sm ">
                    <code className="leading-relaxed md:leading-normal text-gray-600">
                      {/* <!-- HTML_TAG_START --> */}
      ...
      <div
        className="bg-gradient-to-br from-white via-gray-200/20 to-white py-16 dark:from-gray-950 dark:to-gray-900 md:py-32">
        <div className="container grid gap-x-6 gap-y-12 lg:grid-cols-3 lg:gap-y-0">
          <div className="lg:place-self-center lg:pr-12">
            <div className="flex flex-col">
              <svg className="text-indigo-400 text-2xl" xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em"
              ...
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h2 className="false text-2xl font-semibold leading-tight text-gray-800">Inference API
                  </h2>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">Serve your models directly from Hugging Face
                infrastructure and run large scale NLP models in milliseconds
                with just a few lines of code.
              </p>
              <div className="h-6"></div>
              <a href="/inference-api"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Learn
                more</a>
            </div>
          </div>
          <div
            className="flex flex-col overflow-hidden rounded-xl bg-gradient-to-br from-white to-white p-6 shadow-sm dark:border-gray-850 dark:from-gray-925 dark:to-gray-950">
            <div className="truncate">
              <a href="/distilbert-base-uncased" className="text-lg font-semibold">distilbert-base-uncased
              </a>
            </div>
            <div className="flex w-full flex-1">
              <div className="SVELTE_HYDRATER contents"
                ...
                <div className="flex flex-col w-full max-w-full ">
                  ...
                  <div
                    className="mb-0.5 flex w-full max-w-full flex-wrap items-center justify-between text-sm text-gray-500">
                    <a className="hover:underline" href="/tasks/fill-mask" target="_blank"
                      title="Learn more about fill-mask">
                      <div className="inline-flex items-center mr-2 mb-1.5">
                    ...
                    <div className="ml-auto flex gap-x-1">
                      <div className="relative mb-1.5  false false">
                        <div className="inline-flex w-32 justify-between rounded-md border border-gray-100 px-4 py-1">
                          ...
                          <svg className="-mr-1 ml-2 h-5 w-5 transition ease-in-out transform false"
                  ...
                  <form>
                    ...
                    <label className="block ">
                      <span
                        className="  block overflow-auto resize-y py-2 px-3 w-full min-h-[42px] max-h-[500px] whitespace-pre-wrap inline-block border border-gray-200 rounded-lg shadow-inner outline-none focus:ring focus:ring-blue-200 focus:shadow-inner dark:bg-gray-925 svelte-1wfa7x9"
                        role="textbox" contentEditable spellCheck="false"
                        dir="auto"></span>
                        {/* style={{ '--placeholder': 'Your sentence here...' }} */}
                    </label>
                    <button className="btn-widget w-24 h-10 px-5 mt-2" type="submit">Compute</button>
                  </form>
                  <div className="mt-2">
                  ...
                  <div className="mt-auto pt-4 flex items-center text-xs text-gray-500">
                    <button className="flex items-center cursor-not-allowed text-gray-300" disabled>
                      <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <div
            className="flex flex-col overflow-hidden rounded-xl bg-gradient-to-br from-white to-white p-6 shadow-sm dark:border-gray-850 dark:from-gray-925 dark:to-gray-950">
            <div className="truncate">
              <a href="/dbmdz/bert-large-cased-finetuned-conll03-english"
                className="text-lg font-semibold">dbmdz/bert-large-cased-finetuned-conll03-english
              </a>
            </div>
            <div className="flex w-full flex-1">
              <div className="SVELTE_HYDRATER contents"
                ...
                <div className="flex flex-col w-full max-w-full ">
                  ...
                  <div
                    className="mb-0.5 flex w-full max-w-full flex-wrap items-center justify-between text-sm text-gray-500">
                    <a className="hover:underline" href="/tasks/token-classification" target="_blank"
      ...
      <div className="py-16 md:py-32">
        <div className="container grid gap-10 lg:grid-cols-4">
          <div
            className="md:from-gray-50-to-white flex flex-col rounded-tl-lg md:bg-gradient-to-br md:pt-6 md:pl-6 lg:col-span-2">
            <svg className="text-teal-400 text-3xl mb-2" xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em"
              height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
              <path className="uim-primary"
            ...
            <p className="max-w-md text-gray-500">We’re on a journey to advance and democratize NLP for
              everyone. Along the way, we contribute to the
              development of technology for the better.
            </p>
          </div>
          <div className="bg-white">
            <div
              className="mb-6 flex h-36 items-center justify-center rounded-lg bg-gradient-to-r from-pink-50 to-white shadow-inner dark:from-gray-900 dark:to-gray-950">
            ...
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">Multitask Prompted
              ...
              <p className="leading-snug text-gray-500">
                ...
                <a href="https://bigscience.huggingface.co/" target="_blank">BigScience</a>
                .

              </p>
              <div className="h-6"></div>
              <a href="https://bigscience.huggingface.co/blog/t0"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Read
                more</a>
            </div>
          </div>
          <div className="bg-white">
            <div
              className="mb-6 flex h-36 items-center justify-center rounded-lg bg-gradient-to-r from-green-50 to-white shadow-inner dark:from-gray-900 dark:to-gray-950">
              <p className="text-6xl">🐎</p>
            </div>
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">DistilBERT, a distilled
                    version of BERT: smaller, faster, cheaper and lighter
                  </h3>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">A smaller, faster, lighter, cheaper version of BERT
                obtained via model distillation.
              </p>
              <div className="h-6"></div>
          ...
          <div className="bg-white">
            <div
              className="mb-6 flex h-36 items-center justify-center rounded-lg bg-gradient-to-r from-teal-50 to-white shadow-inner dark:from-gray-900 dark:to-gray-950">
              <p className="text-6xl">📚</p>
            </div>
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">Hierarchical Multi-Task
                    Learning
                  </h3>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">Learning embeddings from semantic tasks for multi-task
                learning. We have open-sourced code and a demo.
              </p>
              <div className="h-6"></div>
          ...
          <div className="bg-white">
            <div
              className="mb-6 flex h-36 items-center justify-center rounded-lg bg-gradient-to-r from-indigo-50 to-white shadow-inner dark:from-gray-900 dark:to-gray-950">
              <p className="text-6xl">🐸</p>
            </div>
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">Meta-learning for
                    language modeling
                  </h3>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">A meta learner is trained via gradient descent to
                continuously and dynamically update language model
                weights.
              </p>
              <div className="h-6"></div>
            ...
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">Neuralcoref
                  </h3>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">Our open source coreference resolution library for
                coreference. You can train it on your own dataset and
                language.
              </p>
              <div className="h-6"></div>
              <a href="/coref"
          ...
          <div className="bg-white">
            <div
              className="mb-6 flex h-36 items-center justify-center rounded-lg bg-gradient-to-r from-purple-50 via-purple-50 to-white shadow-inner dark:from-gray-900 dark:to-gray-950">
            ...
            <div className="flex flex-col">
              <div className="flex items-center rounded-lg">
                <div>
                  ...
                  <h3 className="false font-semibold leading-tight text-gray-800">Write with Transformers
                  </h3>
                </div>
              </div>
              <div className="h-6"></div>
              <p className="leading-snug text-gray-500">This web app is the official demo of the Transformers
                repository &#39;s text generation capabilities.
              </p>
              <div className="h-6"></div>
              <a href="https://transformer.huggingface.co/"
                className="mt-auto self-start border-b border-gray-600 pb-0.5 text-gray-800 hover:border-gray-400 hover:text-gray-500">Start
                writing</a>
            </div>
          </div>
        </div>
